namespace DineandDiscover.DAL{
			    ...
			    public class spclfeaturesDAL
			    {
					public virtual string db_connectionstring{get;set;}
			 	    public spclfeaturesDAL(string connectionString)
				    {
					    db_connectionstring=connectionString;
				    }
				  
			        
              public virtual string Add_specialfeatures_avail(spclfeaturesModel model)
			  { 
                            ...
                            using (NpgsqlConnection npsql = new NpgsqlConnection(db_connectionstring))
					        {
						        ...
						        using (var dbCommand = new NpgsqlCommand("\"Add_specialfeatures_avail\"", npsql))
						        {
                                        dbCommand.CommandType = CommandType.StoredProcedure;
								        					...
								        					dbCommand.Parameters.AddWithValue("pvar_spclfeaturesid",NpgsqlDbType.Uuid,(object)model.spclfeaturesid??DBNull.Value);
...
public virtual System.Data.DataTable getById_spclfeatures(string spclfeaturesid)
									 {
										...
										try{
												...
												{
													npsql.Open();
													using (var dbCommand = new NpgsqlCommand("\"getById_sp_spclfeatures\"", npsql))
													{
														dbCommand.CommandType = CommandType.StoredProcedure;
														dbCommand.Parameters.AddWithValue("pvar_spclfeaturesid",(object)spclfeaturesid??DBNull.Value);
			 ...
			 public virtual string  Update_specialfeatures_avail(spclfeaturesModel model)
			 { 
				 String ResponseMessage="";
					try{
				  ...
				  String ResponseMessage="";
					try{ 
							using (NpgsqlConnection npsql = new NpgsqlConnection(db_connectionstring))
							{
								...
								{
										dbCommand.CommandType = CommandType.StoredProcedure;
										dbCommand.Parameters.AddWithValue("pvar_spclfeaturesid",(object)id??DBNull.Value);
...
public virtual System.Data.DataTable get_all_spclfeatures(string tenantid)
			  { 
					...
					try{
							...
							{
								npsql.Open();
								using (var dbCommand = new NpgsqlCommand("\"get_all_spclfeatures\"", npsql))
								{
									dbCommand.CommandType = CommandType.StoredProcedure;
...
public virtual System.Data.DataSet getById_sp_all_spclfeatures(string spclfeaturesid)
			 {
				...
				try{
						...
						{
							npsql.Open();
							using (var dbCommand = new NpgsqlCommand("\"getById_sp_all_spclfeatures\"", npsql))
							{
								dbCommand.CommandType = CommandType.StoredProcedure;
								dbCommand.Parameters.AddWithValue("pvar_spclfeaturesid",(object)spclfeaturesid??DBNull.Value);
								using (NpgsqlDataAdapter dataAdapter = new NpgsqlDataAdapter(dbCommand))
			  ...
			  public virtual string  verify_spclfeatures(string spclfeaturesid,string verifiedby,string verifiedstatus,string reviewcomments)
			 { 
				 String ResponseMessage="";
					try{
							...
							{
								npsql.Open();
								using (var dbCommand = new NpgsqlCommand("\"verify_spclfeatures\"", npsql))
								{
										dbCommand.CommandType = CommandType.StoredProcedure;
										 dbCommand.Parameters.AddWithValue("pvar_spclfeaturesid",(object)spclfeaturesid??DBNull.Value);
...
public virtual System.Data.DataTable lookup_spclfeatures_spclfeatures(String tenantid)
							        {
                                            DataSet dataSet = new DataSet();
									        DataTable dataTable=new DataTable();
									        try{
					                                    ...
					                                    {
						                                    npsql.Open();
						                                    using (var dbCommand = new NpgsqlCommand("\"lookup_spclfeatures_spclfeatures\"", npsql))
						                                    {
