namespace DineandDiscover.Models{
			...
			public class spclfeaturesavailModel
			{

			 public System.Guid ?spclfeaturesavailid	{ get; set; }
...
[xssFilter]
			...
			public class spclfeaturesavailModelValidator: AbstractValidator<spclfeaturesavailModel>
			{
					 
					public spclfeaturesavailModelValidator()
					{
