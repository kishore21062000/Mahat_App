namespace DineandDiscover.Models{
			...
			public class specialfeaturesavailModel
			{

			 public System.Guid ?specialfeaturesavailid	{ get; set; }

public Guid? specialfeaturesavail	{ get; set; }
...
[xssFilter]
			...
			public class specialfeaturesavailModelValidator: AbstractValidator<specialfeaturesavailModel>
			{
					 
					public specialfeaturesavailModelValidator()
					{
