...
{
context.Request.PathBase = "/userslist/";
return next();
});
}
...
if(env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "userslist");
                    c.RoutePrefix = "";
            ...
            else
            {
                    ...
                    {
	                    c.RoutePrefix = "";
	                    c.SwaggerEndpoint("/userslist/swagger/v1/swagger.json", "userslist");
                    });
