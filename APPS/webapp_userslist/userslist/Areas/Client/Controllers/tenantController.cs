namespace Client.Controllers
			{
				...
				//This code generated from Deliveries Powered by Mahat, Source Machine : 15.206.208.9 , Build Number : Build 14092021 #2021-09-014(Updated on 29102021 12:49) on 09/07/2023 11:18:44
			...
			public virtual async Task<IActionResult> Create_tenant(tenantModel model, IFormCollection collection)
			{
			 ...
			 if(strReturnMessage.Replace("\"", "").Contains("201.1")){
				 TempData["message"] = "Success";
						...
						HttpContext.Session.SetString("userslistchoosedtenantid",model.tenantid.ToString());
