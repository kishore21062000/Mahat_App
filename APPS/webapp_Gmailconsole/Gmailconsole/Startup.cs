...
{
context.Request.PathBase = "/Gmailconsole/";
return next();
});
}
...
if(env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Gmailconsole");
                    c.RoutePrefix = "";
            ...
            else
            {
                    ...
                    {
	                    c.RoutePrefix = "";
	                    c.SwaggerEndpoint("/Gmailconsole/swagger/v1/swagger.json", "Gmailconsole");
                    });
