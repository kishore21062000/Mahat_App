...
{
context.Request.PathBase = "/Timemajesty/";
return next();
});
}
...
if(env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Timemajesty");
                    c.RoutePrefix = "";
            ...
            else
            {
                    ...
                    {
	                    c.RoutePrefix = "";
	                    c.SwaggerEndpoint("/Timemajesty/swagger/v1/swagger.json", "Timemajesty");
                    });
