...
if(env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "AIData");
                    c.RoutePrefix = "";
            ...
            {
                    var basePath = "/AIData/AIDataWebApi";
                    app.UseSwagger(c =>
                    {
                    ...
                    {
	                    c.RoutePrefix = "";
	                    c.SwaggerEndpoint("/AIData/AIDataWebApi/swagger/v1/swagger.json", "AIData");
                    });
